  ...
  return (
    <section className="relative overflow-hidden w-full text-white">
      ...
      <div className="absolute inset-0 -z-10 h-full w-full overflow-hidden">
        ...
        {/* Modifié : Le conteneur des images prend désormais 100% de la hauteur du Hero */}
      ...
      {/* Intégré directement dans le flux pour s'assurer qu'il reste sur l'image en mobile */}
