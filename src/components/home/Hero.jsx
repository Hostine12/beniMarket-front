...
export default function Hero() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-ink-900 text-white">
      ...
      {/* ================= CARROUSEL D'IMAGES ================= */}
      {/* Sur Mobile: Hauteur fixe contrôlée (h-[45vh]) | Sur PC: Rempli tout l'arrière-plan (lg:absolute) */}
      <div className="relative lg:absolute lg:inset-0 lg:-z-10 w-full h-[45vh] sm:h-[55vh] lg:h-full overflow-hidden">
        ...
        {/* Overlay progressif pour fondre l'image dans le texte */}
        <div
          className="
            absolute
            inset-0
      ...
      {/* L'arrière-plan bg-ink-900 prend le relais proprement sous l'image en mobile */}
      <div className="relative z-10 bg-ink-900 lg:bg-transparent pb-16 lg:pb-0">
        ...
        <div className="container mx-auto px-4 mt-8">
          ...
          <div className="mt-9 flex flex-wrap justify-center lg:justify-start gap-x-6 gap-y-3 text-sm text-white/90">
            ...
            <span className="flex items-center gap-2">
              <Truck size={18} className="text-teal-300" />
              Livraison 24h
            </span>
            <span className="flex items-center gap-2">
